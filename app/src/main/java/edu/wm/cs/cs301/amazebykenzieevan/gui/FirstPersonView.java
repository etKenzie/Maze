...
import edu.wm.cs.cs301.amazebykenzieevan.generation.BSPBranch;
import edu.wm.cs.cs301.amazebykenzieevan.generation.BSPLeaf;
import edu.wm.cs.cs301.amazebykenzieevan.generation.BSPNode;
import edu.wm.cs.cs301.amazebykenzieevan.generation.Floorplan;
import edu.wm.cs.cs301.amazebykenzieevan.generation.Wall;
...
public class FirstPersonView {
	...
	public void draw(MazePanel panel, int x, int y, int walkStep, int ang, float percentToExit) {
		...
		mazePanel.setColor(ColorTheme.getColor(MazeColors.FIRSTPERSON_DEFAULT));
