...
import edu.wm.cs.cs301.amazebykenzieevan.gui.ColorTheme.MazeColors;
...
public class CompassRose {
     ...
     */
    private final Typeface markerFont;
     ...
     */
    public CompassRose() {
        this(0.9, 1.7, Typeface.create(Typeface.SANS_SERIF,Typeface.BOLD));
    }
     ...
     */
    public CompassRose(double scaler, double markerRadius, Typeface markerFont) {
        this.scaler = scaler;
     ...
     * one in JComponent.
     * @param panel The graphics object to draw on, actually must be a Graphics2D object.
     */
    public void paintComponent(MazePanel panel) {
        ...
        */
        ...
        panel.setRenderingHint(P7PanelF22.P7RenderingHints.KEY_RENDERING, P7PanelF22.P7RenderingHints.VALUE_RENDER_QUALITY);
        panel.setRenderingHint(P7PanelF22.P7RenderingHints.KEY_ANTIALIASING, P7PanelF22.P7RenderingHints.VALUE_ANTIALIAS_ON);
     ...
     * @param panel Maze Panel to draw on
     */
	 ...
	 * @param panel The Maze Panel object to draw on
	 ...
	 * @param panel The panel object to draw on
	 * @param length The length of the arm
	 * @param width The width of the arm
	 * @param x For the x coordinates of the triangle points, first entry given and fixed
	 * @param y For the y coordinates of the triangle points, first entry given and fixed
	 ...
	 * @param panel The MazePanel object to draw on
